  ...
  const color =
    tone === "ok"
      ...
      : tone === "warn"
        ? "var(--yellow)"
        : tone === "missing"
          ? "#fb923c" // bright orange — distinct from red errors
          : "var(--red)";
  return (
    <div
      style={{
    ...
    >
      ...
      <span
        style={{
          color: tone === "missing" ? "#fb923c" : "var(--text)",
          lineHeight: 1.5,
        }}
      >
        {text}
...
export function Section({
  ...
  return (
    ...
    >
      ...
      >
        <span>{title}</span>
        <span style={{ color: "var(--lime)", fontSize: "0.8rem" }}>
          {open ? "▾" : "▸"}
        </span>
      </button>
      {open && (
