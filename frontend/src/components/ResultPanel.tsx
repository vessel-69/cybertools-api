...
function EmptyState() {
  return (
    <div style={{
      ...
      <div style={{ fontSize: '0.75rem', letterSpacing: 2, textTransform: 'uppercase' as const }}>
        Enter a target and run a command
      </div>
      <div style={{
        fontSize: '0.65rem', color: 'var(--text-muted)',
        opacity: 0.6, textAlign: 'center' as const,
  ...
  return (
    <main style={{
      ...
      <div style={{
        ...
        <div style={{
          display: 'flex', gap: 16,
          fontSize: '0.65rem', color: 'var(--text-muted)', letterSpacing: 1,
        }}>
